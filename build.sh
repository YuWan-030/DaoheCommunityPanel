...
cp -f "${BASE_PATH}/LICENSE" "${BASE_PATH}/production-code/LICENSE"
cp -f "${BASE_PATH}/MODIFICATIONS.md" "${BASE_PATH}/production-code/MODIFICATIONS.md"

mv "${BASE_PATH}"/frontend/dist/* "${BASE_PATH}/production-code/web/public"
cp -R "${BASE_PATH}/prod-scripts/linux" "${BASE_PATH}/production-code/prod-scripts/"
chmod +x "${BASE_PATH}/production-code/prod-scripts/linux/"*.sh
