...
6. Простой технологический стек, вам нужно только освоить TypeScript, чтобы завершить всю разработку 稻荷社区!
7. И многое другое...
...
Этот метод установки не регистрирует панель в системных службах автоматически, поэтому вы должны использовать программное обеспечение `screen` для управления. Если вы хотите, чтобы системная служба взяла на себя 稻荷社区, пожалуйста, обратитесь к документации.
...
**Этот раздел для разработчиков.** Если вы хотите заниматься вторичной разработкой 稻荷社区 или отправлять вклады в код, пожалуйста, внимательно прочитайте эти материалы:

### Требуется

Мы используем `Visual Studio Code` для разработки 稻荷社区. Вы **должны установить** эти плагины:
