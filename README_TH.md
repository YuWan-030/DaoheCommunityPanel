...
6. สแต็กเทคโนโลยีที่เรียบง่าย คุณเพียงแค่ต้องเชี่ยวชาญ TypeScript เพื่อทำการพัฒนา 稻荷社区 ทั้งหมดให้เสร็จสิ้น!
7. อื่นๆ...
...
วิธีการติดตั้งนี้ไม่ได้ลงทะเบียนแผงกับบริการระบบโดยอัตโนมัติ ดังนั้นคุณต้องใช้ซอฟต์แวร์ `screen` เพื่อจัดการ หากคุณต้องการให้บริการระบบจัดการ 稻荷社区 กรุณาอ้างอิงเอกสาร
...
**ส่วนนี้สำหรับนักพัฒนา** หากคุณต้องการทำการพัฒนาระดับสองใน 稻荷社区 หรือส่งการมีส่วนร่วมในโค้ด กรุณาอ่านเนื้อหาเหล่านี้อย่างระมัดระวัง:

### จำเป็น

เราใช้ `Visual Studio Code` เพื่อพัฒนา 稻荷社区 คุณต้อง**ติดตั้ง**ปลั๊กอินเหล่านี้:
